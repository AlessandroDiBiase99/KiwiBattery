function PN = ImportaDati(file,sheet)
...
%
% Input:
%    - file: il path del file excel da cui estrapolare le matrici
%    - sheet: il nome del foglio di lavoro sul quale sono presenti le
%             matrici desiderate
% Output:
%    - PN: struct contenente i vettori T e P, che contengono i nomi delle
%          transizioni e dei posti nell'ordine indicato dalle matrici; le
%          matrici Pre, Post, C (combinazione) e H (inibizione); il vettore
%          M0 che indica la marcatura iniziale.
% Authors:
%    - Caponi Luca
%    - Catalini Federico
%    - Di Biase Alessandro
